document.addEventListener('DOMContentLoaded', function () {
  ...
  style.textContent = [
    '.' + animationClass + '{opacity:0;transform:translateY(28px);transition:opacity 0.6s ease,transform 0.6s ease;}',
    '.' + animationClass + '.is-visible{opacity:1;transform:translateY(0);}'
  ].join('');
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "ADEL Travel uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e387542c-2d0d-444e-a385-d04a8e5a54cb',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e387542c-2d0d-444e-a385-d04a8e5a54cb';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e387542c-2d0d-444e-a385-d04a8e5a54cb';
